<header class="header">
    <div class="header-container">
        <div>
            <span class="header-span-text">
                <a href="/main" title="Навигация">Журнал успеваемости</a>
            </span>
        </div>

        <div class="user">
            <span class="username"><a href="/user" title="Профиль"><?php echo $data['user']['name']?></a></span>
            <a href="/auth/signout" class="header-logo" title="Выход из системы">
